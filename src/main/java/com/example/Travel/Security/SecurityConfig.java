...
//                                .requestMatchers(HttpMethod.POST, "/api/flights").hasRole("ADMIN")
//                                .requestMatchers("/api/users/profile").authenticated() // ✅ Allow any authenticated user
//                                .requestMatchers(HttpMethod.POST, "/api/tours").hasRole("ADMIN")
//                                .requestMatchers("/api/admin/**").hasRole("ADMIN")
//                                .anyRequest().authenticated()
//                )
//                // In filterChain method, add these permissions:
////                .authorizeHttpRequests(authz -> authz
////                        .requestMatchers("/api/auth/**").permitAll()  // Already have this
////                        .requestMatchers("/swagger-ui/**").permitAll()
////                        .requestMatchers("/v3/api-docs/**").permitAll()
////                        .requestMatchers("/api/tours/**").permitAll()  // Allow tour browsing without auth
////                        .requestMatchers("/api/flights/**").permitAll() // Allow flight search without auth
////                        .anyRequest().authenticated()
////                )
//                .sessionManagement(session -> session
//                        .sessionCreationPolicy(SessionCreationPolicy.STATELESS)
...
//    }
//
//    // In SecurityConfig.java - replace corsConfigurationSource()
//    @Bean
//    public CorsConfigurationSource corsConfigurationSource() {
//        CorsConfiguration config = new CorsConfiguration();
//        config.setAllowedOrigins(Arrays.asList(
...
//                "http://10.0.2.2",
//                "http://localhost",
//                "http://192.168.20.55",  // Add your IP
//                "http://192.168.20.55:8080" // With port
//        ));
...
//    public CorsConfigurationSource corsConfigurationSource() {
//        CorsConfiguration config = new CorsConfiguration();
//        config.setAllowedOrigins(List.of("http://localhost:4200")); // SPECIFIC Angular URL
//        config.setAllowedMethods(List.of("GET", "POST", "PUT", "DELETE", "OPTIONS"));
//        config.setAllowedHeaders(List.of("*"));
//        config.setAllowCredentials(true);
//        config.setExposedHeaders(List.of("Authorization"));
